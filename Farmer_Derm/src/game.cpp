...
void farm_game::Game::ProcessEvents() {
	sf::Event event;
...
void farm_game::Game::Update(sf::Time delta_time) {
...
void farm_game::Game::Render() {
	render_window_.clear();
	render_window_.draw(player_);
	render_window_.display();
}

void farm_game::Game::HandlePlayerInput(sf::Keyboard::Key key, bool is_pressed) {
